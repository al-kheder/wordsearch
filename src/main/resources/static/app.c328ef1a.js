  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetchGridInfo(["Ali", "TWO", "THREE"]);
...
function _fetchGridInfo() {
  _fetchGridInfo = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(wordList) {
    var comaSepratedWord, respons, result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            comaSepratedWord = wordList.join(",");
            _context2.next = 3;
            return fetch("http://localhost:8080/wordgrid?gridSize=".concat(GRID_SIZE, "&wordList=").concat(comaSepratedWord));
...
},{"./grid":"grid.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
