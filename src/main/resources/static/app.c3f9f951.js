...
function () {
  ...
  (0, _createClass2.default)(Grid, [{
    ...
    value: function renderGrid(gridSize, wordGrid) {
      ...
      tbl.appendChild(tblBody); //  tbl.setAttribute("border", "1");

      gridArea.appendChild(tbl); // click handler
...
exports.Grid = Grid;
},{"@babel/runtime/helpers/classCallCheck":"../node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"../node_modules/@babel/runtime/helpers/createClass.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
_regenerator.default.mark(function _callee() {
  var grid, commaSepratedWords, gridSize, result, wordListNode, wordListSection;
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          grid = new _grid.Grid();
          commaSepratedWords = document.querySelector("#add-word").value;
          gridSize = document.querySelector("#grid-size").value;
          _context.next = 5;
          return fetchGridInfo(gridSize, commaSepratedWords);

        case 5:
          result = _context.sent;
          grid.words = commaSepratedWords.split(",");
...
function _fetchGridInfo() {
  _fetchGridInfo = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(gridSize, commaSepratedWords) {
    var respons, result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("http://localhost:8080/wordgrid?gridSize=".concat(gridSize, "&wordList=").concat(commaSepratedWords));
...
},{"@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","./grid":"js/grid.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
